...
export default function PrivacyPolicyPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF7F1]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <Panel title={`📋 ${t.collect_title}`}>
          <div className="grid md:grid-cols-2 gap-5">
            <Item text={t.collect_1} />
            <Item text={t.collect_2} />
            <Item text={t.collect_3} />
            <Item text={t.collect_4} />
            <Item text={t.collect_5} />
            <Item text={t.collect_6} />
          </div>
        </Panel>

        {/* How We Use */}
        <Panel title={`📌 ${t.use_title}`}>
          <div className="grid md:grid-cols-2 gap-5">
            <Item text={t.use_1} />
            <Item text={t.use_2} />
            <Item text={t.use_3} />
        ...
        {/* Data Security */}
        <Panel title={`🔐 ${t.security_title}`}>
          <div className="grid gap-5">
            <Item text={t.security_1} />
            <Item text={t.security_2} />
            <Item text={t.security_3} />
          </div>
        </Panel>

        {/* Your Rights */}
        <Panel title={`👤 ${t.rights_title}`}>
          <div className="grid gap-5">
            <Item text={t.rights_1} />
            <Item text={t.rights_2} />
            <Item text={t.rights_3} />
          </div>
        </Panel>
  ...
  localStorage.setItem(
    "donor_privacy_accepted",
    "true"
  );

  localStorage.setItem(
    "donor_privacy_accepted_at",
